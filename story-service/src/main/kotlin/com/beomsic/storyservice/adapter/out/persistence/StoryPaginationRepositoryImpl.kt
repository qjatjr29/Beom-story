                ...
                databaseClient.sql(
                    ...
                    .map { row, _ ->
                        StoryEntity(
                            ...
                            category = row.get("category", Category::class.java) ?: throw IllegalStateException("category is required"),
                            status = row.get("status", StoryStatus::class.java) ?: throw IllegalStateException("status is required"),
